...
The request and response shapes the Covenant surfaces will use are frozen; the routes and the maintenance and recovery implementations are not. **No route in this section is registered yet.** It is documented here because four surfaces build against these shapes, and a contract that four of them each invent separately is four contracts.
