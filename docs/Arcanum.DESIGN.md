...
| `Arcanum:Providers` | array | `[]` | element `contextWindowLimit` 256 – 2,097,152 | Multi-provider hub. Model entries may be legacy strings or objects with `name`, `supportsVision`, optional `reasoning`, and optional `tokenization`. |
