...
| `Arcanum:Attachments:MaxReferencesPerTurn` | `int` | `8` | 1 – 32 | Cap on `PingRequest.AttachmentReferences` per turn. |
...
See [PERSISTENCE.md](Arcanum.PERSISTENCE.md) for schema invariants, pending GC, and uninstall/copy notes. Config: §3.4 (`Arcanum:Attachments:*`).
