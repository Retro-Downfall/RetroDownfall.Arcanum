...
process-local streams, and the live A2A task-id index is a runtime index that disappears on restart
(its durable correspondence lives in the `LongRunningOperations` ledger — §5.7.1.2).
