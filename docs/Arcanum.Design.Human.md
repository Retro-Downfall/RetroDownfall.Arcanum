...
Real composed SQLCipher acceptance proves same-process old-lease revocation, all-six-token rejection, warm-writer and ordinary-read freshness, plus fresh-process adoption and resume. The internal coordinator is intentionally not wired to public reset or factory-erasure entry points in this build. They still refuse without mutation, and issue #128 owns activation.
