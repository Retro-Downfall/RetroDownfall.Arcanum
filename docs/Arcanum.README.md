...
| Durable operator-and-agent standing agreement | **The Covenant** | (internal until issue #88; `Data/Schema/Capabilities/Covenant/`, `Core/Covenant/`, `Infrastructure/Covenant/`) |
