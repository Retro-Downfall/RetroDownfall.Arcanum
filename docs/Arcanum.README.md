...
| Durable operator-and-agent standing agreement | **The Covenant** | (no operator surface until issue #88; `propose_covenant` / `retire_covenant` MCP tools, `Data/Schema/Capabilities/Covenant/`, `Core/Covenant/`, `Infrastructure/Covenant/`) |
