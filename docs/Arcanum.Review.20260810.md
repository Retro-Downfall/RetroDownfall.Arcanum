...
1. src/RetroDownfall.Arcanum.Cli/Commands/ServeCommand.cs:313-338 defines RedirectConsoleToBootstrapLog(), which creates and writes the exact file:
       internal static voi
