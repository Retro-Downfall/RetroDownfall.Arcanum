...
>
> **Branch status.** This #120 update is intentionally local to `long-term-memory` until the project's normal mirror reaches `main`; this issue delivery does not merge or rewrite `main`. Read this guide with the implementation branch; section 11 is the boundary.
