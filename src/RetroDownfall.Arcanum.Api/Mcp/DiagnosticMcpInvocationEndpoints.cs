...
/// <summary>
/// Diagnostic MCP Invocation endpoint — <c>POST /api/mcp/tools/invoke</c>. Policy-constrained direct
/// invocation of <strong>external</strong> MCP tools by an operator. Not model execution; not
/// unauthenticated (inherits <c>X-Arcanum-Key</c>). Internal <c>arcanum-internal</c> server and all
/// Forbidden Arts are blocked. See <see cref="DiagnosticMcpInvocationService"/> for the full policy.
/// </summary>
