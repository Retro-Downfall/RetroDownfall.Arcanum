...
public sealed record GuardrailsSettings
{
    ...
    /// </summary>
    public bool BlockToxicity { get; init; }
    ...
    /// </summary>
    public string[] ToxicityBlocklist { get; init; } = [];
    ...
    /// </summary>
    public string[] AllowedTopics { get; init; } = [];
    ...
    /// </summary>
    public string[] BlockedTopics { get; init; } = [];
    ...
    /// </summary>
    public GuardrailsAuditLogSettings AuditLog { get; init; } = new();
    ...
    /// </summary>
    public string StreamingMode { get; init; } = "passthrough";
