...
public sealed record ResilienceSettings
{
    ...
    /// </summary>
    public int HealthProbeIntervalSeconds { get; init; } = 30;
    ...
    /// </summary>
    public int HealthRecoveryProbeIntervalSeconds { get; init; } = 60;
    ...
    /// </summary>
    public int HealthFailureThreshold { get; init; } = 3;
