...
public sealed record SagaEmbeddingSettings
{
    ...
    /// </summary>
    public bool ExtractionEnabled { get; init; } = true;
    ...
    /// </summary>
    public int MaxMemoriesPerSession { get; init; } = 50;
    ...
    /// </summary>
    public int MaxMemoriesTotal { get; init; } = 10_000;
    ...
    /// runtime.
    /// </summary>
    public int ExtractionMaxTokens { get; init; } = 500;
    ...
    /// </summary>
    public int ExtractionIntervalMinutes { get; init; } = 15;

    /// <summary>
    /// Number of recent Grimoire entries reviewed per extraction call. Default <c>10</c>; clamped
    /// 2–50 at runtime.
    /// </summary>
    public int ExtractionWindowEntries { get; init; } = 10;
