...
/// Deserialized via <c>ArcanumCoreJsonContext.Default.SagaExtractionResponse</c> (AOT-safe source
...
/// </summary>
public sealed record SagaExtractionResponse(JsonElement[] Memories);
