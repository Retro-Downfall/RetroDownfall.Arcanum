...
CREATE INDEX IF NOT EXISTS idx_covenant_curation_receipts_campaign_cleanup
    ON covenant_curation_receipts(CampaignId);

CREATE INDEX IF NOT EXISTS idx_covenant_curation_receipts_resulting_version
    ON covenant_curation_receipts(ResultingVersionId);
