...
CREATE TRIGGER IF NOT EXISTS session_attachment_index_state_AttachmentId_guard_identity_update
BEFORE UPDATE OF AttachmentId ON session_attachment_index_state
