...
CREATE TRIGGER IF NOT EXISTS attachment_memory_consultations_AttachmentId_guard_identity_update
BEFORE UPDATE OF AttachmentId ON attachment_memory_consultations
