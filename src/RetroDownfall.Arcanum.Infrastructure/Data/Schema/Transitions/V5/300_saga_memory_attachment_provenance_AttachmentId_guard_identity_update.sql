...
CREATE TRIGGER IF NOT EXISTS saga_memory_attachment_provenance_AttachmentId_guard_identity_update
BEFORE UPDATE OF AttachmentId ON saga_memory_attachment_provenance
