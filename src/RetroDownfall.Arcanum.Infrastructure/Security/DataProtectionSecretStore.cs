    ...
    IApiKeyDigestCache apiKeyDigestCache) : ISecretStore, IDisposable
{
    ...
    private const string CorruptApiKeyRecoveryMessage =
        ...
        + "Stop the host, then follow the \"Local Grimoire reinstall\" guidance in README.md: remove both security.dat and the Grimoire .db under ~/.config/arcanum/, or restore from backup. "
