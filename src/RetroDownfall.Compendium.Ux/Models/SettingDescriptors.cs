...
public static class SettingDescriptors
{
    ...
    [
        ...
        new("features.annals", ConfigSection.Features, "Remember how memory changed (The Annals)", "On by default, this records automatic Saga and Lexicon history without changing what the AI recalls. Turning it off stops only future automatic records: existing history stays readable, and state-changing corrections, retirements, and reinstatements still record required evidence. A memory saved during opt-out gains no automatic history later.", SettingKind.Bool),
