...
public static class SettingDescriptors
{
    ...
    [
        ...
        new("integrations.a2A.allowedRemoteAgents", ConfigSection.Integrations, "Trusted AI systems", "List of other AI systems allowed to connect.", SettingKind.StringArray, Group: "AI collaboration", Placeholder: "https://other-ai.example.com, https://partner.example.org"),
        ...
        new("integrations.embeddings.codebaseIndexing.watcherDebounceMilliseconds", ConfigSection.Integrations, "Code index save debounce (ms)", "Wait this long for editor save events to settle before updating semantic code search.", SettingKind.Int, 50, 5_000, 50, ClampName: nameof(ArcanumSettingClamps.EmbeddingsCodebaseWatcherDebounceMilliseconds), Group: "Semantic code indexing", Placeholder: "300"),
        new("integrations.embeddings.codebaseIndexing.maxWatchers", ConfigSection.Integrations, "Maximum watched projects", "Maximum projects monitored for immediate semantic index updates. Set to 0 to use periodic reconciliation only.", SettingKind.Int, 0, 128, 1, ClampName: nameof(ArcanumSettingClamps.EmbeddingsCodebaseMaxWatchers), Group: "Semantic code indexing", Placeholder: "32"),
        new("integrations.embeddings.codebaseIndexing.reconciliationIntervalMinutes", ConfigSection.Integrations, "Code index reconciliation (minutes)", "How often to verify each semantic code index with a bounded full scan, even while watchers are healthy.", SettingKind.Int, 1, 1_440, 1, ClampName: nameof(ArcanumSettingClamps.EmbeddingsCodebaseReconciliationIntervalMinutes), Group: "Semantic code indexing", Placeholder: "60"),
        new("integrations.embeddings.attachmentIndexing.maxAttachmentBytes", ConfigSection.Integrations, "Maximum indexed attachment bytes", "Largest text attachment eligible for semantic extraction.", SettingKind.Int, 1_024, 20_971_520, 1_024, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentMaxBytes), Group: "Semantic attachment indexing", Placeholder: "2097152"),
        new("integrations.embeddings.attachmentIndexing.maxExtractedCharacters", ConfigSection.Integrations, "Maximum extracted characters", "Maximum decoded visible text retained from one attachment version.", SettingKind.Int, 1_000, 1_000_000, 1_000, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentMaxExtractedCharacters), Group: "Semantic attachment indexing", Placeholder: "200000"),
        new("integrations.embeddings.attachmentIndexing.chunkSizeCharacters", ConfigSection.Integrations, "Attachment chunk size", "Maximum characters in each attachment search chunk.", SettingKind.Int, 128, 8_192, 128, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentChunkSizeCharacters), Group: "Semantic attachment indexing", Placeholder: "1000"),
        new("integrations.embeddings.attachmentIndexing.chunkOverlapCharacters", ConfigSection.Integrations, "Attachment chunk overlap", "Characters repeated between adjacent attachment chunks; the runtime also keeps this below chunk size.", SettingKind.Int, 0, 8_191, 1, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentChunkOverlapCharacters), Group: "Semantic attachment indexing", Placeholder: "100"),
        new("integrations.embeddings.attachmentIndexing.maxChunksPerAttachment", ConfigSection.Integrations, "Maximum chunks per attachment", "Hard cap on chunks generated for one attachment version.", SettingKind.Int, 1, 2_048, 1, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentMaxChunksPerAttachment), Group: "Semantic attachment indexing", Placeholder: "256"),
        new("integrations.embeddings.attachmentIndexing.maxAttachmentsPerBatch", ConfigSection.Integrations, "Attachments per indexing batch", "Maximum attachment versions processed in one background batch.", SettingKind.Int, 1, 100, 1, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentMaxAttachmentsPerBatch), Group: "Semantic attachment indexing", Placeholder: "8"),
        new("integrations.embeddings.attachmentIndexing.queueCapacity", ConfigSection.Integrations, "Attachment indexing queue size", "Maximum attachment versions waiting for background indexing.", SettingKind.Int, 1, 10_000, 1, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentQueueCapacity), Group: "Semantic attachment indexing", Placeholder: "256"),
        new("integrations.embeddings.attachmentIndexing.maxRetries", ConfigSection.Integrations, "Attachment indexing retries", "Maximum retries after transient embedding or storage failures.", SettingKind.Int, 0, 10, 1, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentMaxRetries), Group: "Semantic attachment indexing", Placeholder: "3"),
        new("integrations.embeddings.attachmentIndexing.retryDelaySeconds", ConfigSection.Integrations, "Attachment retry delay", "Seconds to wait before retrying a transient attachment indexing failure.", SettingKind.Int, 1, 300, 1, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentRetryDelaySeconds), Group: "Semantic attachment indexing", Placeholder: "5"),
        new("integrations.embeddings.attachmentIndexing.processingTimeoutSeconds", ConfigSection.Integrations, "Attachment processing timeout", "Maximum wall-clock time for one attachment indexing attempt.", SettingKind.Int, 5, 600, 5, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentProcessingTimeoutSeconds), Group: "Semantic attachment indexing", Placeholder: "60"),
        new("integrations.embeddings.attachmentIndexing.maxRetrievedChunks", ConfigSection.Integrations, "Retrieved attachment chunks", "Maximum relevant attachment excerpts injected into one inference turn.", SettingKind.Int, 1, 50, 1, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentMaxRetrievedChunks), Group: "Semantic attachment indexing", Placeholder: "5"),
        new("integrations.embeddings.attachmentIndexing.maxRetrievedAttachments", ConfigSection.Integrations, "Retrieved attachments", "Maximum distinct session attachments represented by semantic excerpts in one inference turn.", SettingKind.Int, 1, 100, 1, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentMaxRetrievedAttachments), Group: "Semantic attachment indexing", Placeholder: "4"),
        new("integrations.embeddings.attachmentIndexing.maxRetrievedBytes", ConfigSection.Integrations, "Retrieved attachment bytes", "Maximum UTF-8 bytes of semantically retrieved attachment excerpts in one inference turn.", SettingKind.Int, 1024, 16777216, 1024, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentMaxRetrievedBytes), Group: "Semantic attachment indexing", Placeholder: "262144"),
        new("integrations.embeddings.attachmentIndexing.maxRetrievedTokens", ConfigSection.Integrations, "Retrieved attachment tokens", "Maximum estimated tokens consumed by semantically retrieved attachment excerpts in one inference turn.", SettingKind.Int, 128, 1048576, 128, ClampName: nameof(ArcanumSettingClamps.EmbeddingsAttachmentMaxRetrievedTokens), Group: "Semantic attachment indexing", Placeholder: "32768"),
        ...
        new("execution.maxPendingApprenticeStarts", ConfigSection.Execution, "Assistant queue size", "Maximum number of AI assistants waiting to start.", SettingKind.Int, 1, 1_000, 1, ClampName: nameof(ArcanumSettingClamps.MaxPendingStarts), Placeholder: "100"),
