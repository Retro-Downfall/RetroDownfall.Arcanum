...
public static class SettingDescriptors
{
    ...
    [
        ...
        new("security.ward.enabled", ConfigSection.Security, "Legacy Ward switch", "Retained for configuration compatibility. No ordinary or Covenant-retirement live path consumes this setting.", SettingKind.Bool, Group: "Safety checks"),
        ...
        new("security.ward.autoDenyInUnattendedMode", ConfigSection.Security, "Legacy unattended rejection", "Retained for configuration compatibility. No ordinary or Covenant-retirement live path consumes this setting.", SettingKind.Bool, Group: "Safety checks"),
        ...
        new("security.ward.autoApprove.enabled", ConfigSection.Security, "Legacy auto-approval switch", "Retained for configuration compatibility. No ordinary or Covenant-retirement live path consumes this setting; containment remains active.", SettingKind.Bool, Group: "Safety checks"),
        new("security.ward.autoApprove.tools", ConfigSection.Security, "Legacy auto-approval names", "Retained exact tool-name list. No ordinary or Covenant-retirement live path consumes it.", SettingKind.StringArray, Group: "Safety checks", Placeholder: "legacy_tool_name"),
