...
public static class SettingDescriptors
{
    ...
    [
        ...
        new("providers.command", ConfigSection.Providers, "Command", "For a subscription CLI provider: the command to run. Leave blank to find 'claude' or 'codex' on your PATH.", SettingKind.String, Group: "Subscription CLI", Placeholder: "/opt/homebrew/bin/claude"),
        new("providers.hiddenModels", ConfigSection.Providers, "Hidden models", "For a subscription CLI provider: model names to leave out of lists and pickers. Anything not listed here stays available, including models released after you set this up. Hiding is a tidiness preference — a hidden model still runs if you name it directly.", SettingKind.StringArray, Group: "Subscription CLI", Placeholder: "claude-3-haiku-legacy"),
        ...
        new("security.ward.enabled", ConfigSection.Security, "Enable Covenant approval", "Retained for Covenant retirement approval. Ordinary tool calls never wait for approval.", SettingKind.Bool, Group: "Safety checks"),
        new("security.ward.forbiddenArts", ConfigSection.Security, "Tools hidden by restricted policy", "Tool names hidden when a request uses the no-Forbidden-Arts policy. This list does not block execution.", SettingKind.StringArray, Group: "Safety checks", Placeholder: "write_file, execute_command"),
        new("security.ward.autoDenyInUnattendedMode", ConfigSection.Security, "Legacy unattended rejection", "Retained for configuration compatibility. Ordinary unattended tool calls ignore this setting.", SettingKind.Bool, Group: "Safety checks"),
        new("security.ward.unattendedMode", ConfigSection.Security, "Unattended mode default", "Use unattended mode by default for operator-facing chat. This does not Ward-deny ordinary tools.", SettingKind.Bool, Group: "Safety checks"),
        new("security.ward.autoApprove.enabled", ConfigSection.Security, "Pre-authorize Covenant retirement", "Allow the retained Covenant retirement policy to use the exact tool-name list below. Ordinary tool calls ignore this setting and all containment checks remain active.", SettingKind.Bool, Group: "Safety checks"),
        new("security.ward.autoApprove.tools", ConfigSection.Security, "Covenant tools approved in advance", "Exact tool names eligible for retained Covenant auto-approval. Only retire_covenant currently consumes this policy; ordinary tools ignore it.", SettingKind.StringArray, Group: "Safety checks", Placeholder: "retire_covenant"),
        ...
        new("features.campaignScopedMemory", ConfigSection.Features, "Keep memory inside its campaign", "Let long-term memory follow the work rather than the whole installation. When on, the AI recalls what it learned in this campaign plus anything saved for every campaign, and nothing from other campaigns. Turning it off again restores the wider recall; no memory is deleted either way.", SettingKind.Bool),
        new("features.annals", ConfigSection.Features, "Remember how memory changed (The Annals)", "Keep a record of what each memory claimed, who said it, when it was true, and when Arcanum learned it. Corrections are added rather than overwritten, so earlier records stay readable. This changes nothing the AI recalls; it is the history behind it. Turning it off stops new records; a memory saved while it was off has no record and does not gain one later.", SettingKind.Bool),
        ...
        new("integrations.a2A.inputModes", ConfigSection.Integrations, "Accepted content types", "Content types other AI systems may send. Leave blank for plain text only.", SettingKind.StringArray, Group: "AI collaboration", Placeholder: "text/plain, text/markdown"),
        new("integrations.a2A.outputModes", ConfigSection.Integrations, "Produced content types", "Content types this Arcanum can answer with. A system that accepts none of these is told so instead of quietly receiving plain text.", SettingKind.StringArray, Group: "AI collaboration", Placeholder: "text/plain, text/markdown"),
        new("integrations.a2A.skills.id", ConfigSection.Integrations, "Advertised skill id", "Stable identifier other AI systems match on. Leave the skill list empty to advertise the default goal-execution skill.", SettingKind.String, Group: "AI collaboration", Placeholder: "code-review"),
        new("integrations.a2A.skills.name", ConfigSection.Integrations, "Advertised skill name", "Display name for this skill. Defaults to the skill id.", SettingKind.String, Group: "AI collaboration", Placeholder: "Code review"),
        new("integrations.a2A.skills.description", ConfigSection.Integrations, "Advertised skill description", "What this skill does, shown to other AI systems.", SettingKind.String, Group: "AI collaboration", Placeholder: "Reviews a diff and reports defects."),
        new("integrations.a2A.skills.inputModes", ConfigSection.Integrations, "Skill accepted content types", "Content types this skill accepts. Leave blank to inherit the system-wide list.", SettingKind.StringArray, Group: "AI collaboration", Placeholder: "text/plain"),
        new("integrations.a2A.skills.outputModes", ConfigSection.Integrations, "Skill produced content types", "Content types this skill answers with. Leave blank to inherit the system-wide list.", SettingKind.StringArray, Group: "AI collaboration", Placeholder: "text/plain"),
        new("integrations.a2A.pushNotifications", ConfigSection.Integrations, "Let AI systems report back", "Allow other AI systems to be told when a task changes instead of waiting on an open connection — and to tell this Arcanum the same. Off unless you turn it on.", SettingKind.Bool, Group: "AI collaboration"),
        new("integrations.a2A.pushCallbackBaseUrl", ConfigSection.Integrations, "Address other AI systems reply to", "Public web address other AI systems can reach this Arcanum at, so they can report a finished task. Leave blank to keep waiting on an open connection instead.", SettingKind.String, Group: "AI collaboration", Placeholder: "https://arcanum.example.com"),
