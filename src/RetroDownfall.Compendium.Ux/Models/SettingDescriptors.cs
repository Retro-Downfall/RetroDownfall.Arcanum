...
public static class SettingDescriptors
{
    ...
    [
        ...
        new("security.ward.autoApprove.enabled", ConfigSection.Security, "Approve trusted commands in advance", "WARNING: this gives the AI your approval ahead of time for the commands you list below, so they run without asking. Everything else still asks. Folder limits and other protections always apply. Off unless you turn it on.", SettingKind.Bool, Group: "Safety checks"),
        new("security.ward.autoApprove.tools", ConfigSection.Security, "Commands approved in advance", "Exact command names that may run without asking, once the setting above is on. Leave empty to keep asking for everything. Listing a command you do not have does nothing.", SettingKind.StringArray, Group: "Safety checks", Placeholder: "apply_patch, workspace_check"),
