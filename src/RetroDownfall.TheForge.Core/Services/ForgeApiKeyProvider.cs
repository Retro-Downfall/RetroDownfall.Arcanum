...
/// <summary>
/// Default <see cref="IForgeApiKeyProvider"/>: resolves via <see cref="ApiKeyResolver"/> once and
/// caches the result in memory for the process lifetime. Optionally prompts for a paste when empty.
/// </summary>
public sealed class ForgeApiKeyProvider : IForgeApiKeyProvider
{
    ...
    private readonly ILogger<ForgeApiKeyProvider> _logger;
    ...
    public ForgeApiKeyProvider(
        ApiKeyResolver resolver,
        IOptionsMonitor<ForgeSettings> settings,
        ILogger<ForgeApiKeyProvider> logger,
