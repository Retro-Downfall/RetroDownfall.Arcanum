...
public sealed class GrimoireSchemaVersionChainTests
{
    ...
    /// <summary>
    /// Core left version 1 for Campaign-scoped recall, the Annals, Saga curation, canonical identity
    /// spelling, retention/indexing support, the Saga extraction cursor, and exact Session cost storage;
    /// Covenant canonical left it for curation and receipt-free agent retirement; the Covenant
