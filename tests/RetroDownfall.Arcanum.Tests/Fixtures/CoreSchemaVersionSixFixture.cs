...
/// <summary>
/// The Core head tree as it stood at schema version 6, reconstructed so version 7 can be exercised
...
internal static class CoreSchemaVersionSixFixture
{
    ...
    private const string AssistantEntryFinalizationsSql =
        """
    ...
    [
        .. GrimoireSchemaCatalog.CoreObjects
            ...
            {
                "saga_extraction_watermarks" => definition with
                {
                    Sql = SagaExtractionWatermarksSql.ReplaceLineEndings("\n"),
                },
                "assistant_entry_finalizations" => definition with
                {
                    Sql = AssistantEntryFinalizationsSql.ReplaceLineEndings("\n"),
                },
                _ => definition,
            }),
    ];
            ...
            new GrimoireSchemaVersionChain(
                ...
                [
                    .. GrimoireSchemaVersionChains.Default
                        ...
                        .Steps
                        .Where(static step => step.ToVersion <= 6),
                ]),
