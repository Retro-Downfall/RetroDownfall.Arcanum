...
internal static class GrimoireConnectionAcquisitionScanner
{
    ...
    [
        ...
        new(
            new("src/RetroDownfall.Arcanum.Infrastructure/Repositories/SessionEntryPersistence.cs", "SessionEntryPersistence", "ReadProbeOnFreshConnectionAsync(2)", AcquisitionConstructKind.ProviderOpen, "connection.OpenAsync", 1, "connection.OpenAsync(cancellationToken)"),
            GrimoirePathAuthority.LiveGrimoire,
            GrimoireAcquisitionKind.ServingRawOrdinary,
            GrimoireRuntimeAdmissionRoute.OrdinaryConnectionFactory,
            null),
        ...
        new(
            new("src/RetroDownfall.Arcanum.Infrastructure/Repositories/SessionEntryPersistence.cs", "SessionEntryPersistence", "ReadReceiptOnFreshConnectionAsync(3)", AcquisitionConstructKind.ProviderOpen, "connection.OpenAsync", 1, "connection.OpenAsync(cancellationToken)"),
            GrimoirePathAuthority.LiveGrimoire,
            GrimoireAcquisitionKind.ServingRawOrdinary,
            GrimoireRuntimeAdmissionRoute.OrdinaryConnectionFactory,
            null),
        ...
        new(
            new("src/RetroDownfall.Arcanum.Infrastructure/Data/LongRunningOperationStore.cs", "LongRunningOperationStore", "RenewLeaseAsync(5)", AcquisitionConstructKind.ProviderOpen, "connection.OpenAsync", 1, "connection.OpenAsync(cancellationToken)"),
            GrimoirePathAuthority.LiveGrimoire,
            GrimoireAcquisitionKind.ServingRawOrdinary,
            GrimoireRuntimeAdmissionRoute.OrdinaryConnectionFactory,
            null),
        ...
        ICollection<(string Name, AcquisitionIdentity Identity)> markedRoutes)
    {
        ...
        if ((ReturnsConnectionOwningType(method.ReturnType) || ContainsProviderOpen(method)) && !IsMarked(method))
        {
            ...
            failures.Add(new(
                ...
                identity,
                "A concrete connection-owning route requires GrimoireConnectionAcquisitionRoute."));
    ...
    private static bool ReturnsConnectionOwningType(TypeSyntax type)
    {
        ...
        if (ConnectionOwningReturnNames.Contains(terminalName))
        {
        ...
        if (type is NullableTypeSyntax nullable)
        {
            ...
            return ReturnsConnectionOwningType(nullable.ElementType);
            ...
            && RecursiveReturnWrappers.Contains(generic.Identifier.ValueText))
        {
            ...
            return generic.TypeArgumentList.Arguments.Any(ReturnsConnectionOwningType);
        ...
        if (type is QualifiedNameSyntax qualified)
        {
            ...
            return ReturnsConnectionOwningType(qualified.Right);
        ...
        if (type is AliasQualifiedNameSyntax aliasQualified)
        {
            ...
            return ReturnsConnectionOwningType(aliasQualified.Name);
