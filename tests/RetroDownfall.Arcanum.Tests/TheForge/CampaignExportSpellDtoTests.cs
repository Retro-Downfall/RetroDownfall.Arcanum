...
public sealed class CampaignExportSpellDtoTests
{
    ...
    public void Serialize_writes_spellJson_and_omits_null_skillJson()
    {
        ...
        string json = JsonSerializer.Serialize(dto, TheForgeJsonContext.Default.CampaignExportSpellDto);
    ...
    public void Deserialize_accepts_legacy_skillJson()
    {
        ...
        CampaignExportSpellDto? dto = JsonSerializer.Deserialize(json, TheForgeJsonContext.Default.CampaignExportSpellDto);
